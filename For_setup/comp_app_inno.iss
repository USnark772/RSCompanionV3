...
#define MyAppVersion "2.0"                                                   ; UPDATE TO CORRECT VERSION
#define OutputName "companion_app_v2_0"                                      ; UPDATE TO CORRECT VERSION
#define FilePath "C:\RSDev\Builds\Version 2\Build 2.0\build\exe.win32-3.7\"  ; UPDATE TO CORRECT FILEPATH
#define OutputFilePath "C:\RSDev\Builds\Version 2\Build 2.0\installer"       ; UPDATE TO CORRECT FILEPATH
