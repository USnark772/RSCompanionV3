...
english = {StringsEnum.CONFIG_TAB_LABEL: "Configuration",
           ...
           StringsEnum.FPS_SELECTOR_TOOLTIP: "Choose fps to save at. (May duplicate or drop frames)",
           ...
           StringsEnum.USE_OVERLAY_TOOLTIP: "Use overlay on this camera.",
...
dutch = {StringsEnum.CONFIG_TAB_LABEL: "Configuratie",
         ...
         StringsEnum.USE_OVERLAY_CHECKBOX_LABEL: "Gebruik Overlay",
         ...
         StringsEnum.FPS_SELECTOR_TOOLTIP: "Kies fps om op te slaan. (Kan frames dupliceren of neerzetten)",
         ...
         StringsEnum.USE_OVERLAY_TOOLTIP: "Gebruik overlay op deze camera.",
...
french = {StringsEnum.CONFIG_TAB_LABEL: "Configuration",
          ...
          StringsEnum.USE_OVERLAY_CHECKBOX_LABEL: "Utiliser la superposition",
          ...
          StringsEnum.FPS_SELECTOR_TOOLTIP: "Choisissez fps pour enregistrer. (Peut dupliquer ou supprimer des images)",
          ...
          StringsEnum.USE_OVERLAY_TOOLTIP: "Utiliser la superposition sur cet appareil photo.",
...
german = {StringsEnum.CONFIG_TAB_LABEL: "Konfiguration",
          ...
          StringsEnum.USE_OVERLAY_CHECKBOX_LABEL: "Verwenden Sie Overlay",
          ...
          StringsEnum.FPS_SELECTOR_TOOLTIP: "Wählen Sie fps zum Speichern unter. (Kann Frames duplizieren oder löschen)",
          ...
          StringsEnum.USE_OVERLAY_TOOLTIP: "Verwenden Sie Overlay für diese Kamera.",
...
# TODO: Check russian translations
# Russian strings
russian = {StringsEnum.CONFIG_TAB_LABEL: "конфигурация",
           ...
           StringsEnum.FPS_SELECTOR_TOOLTIP: "Выберите fps для сохранения в. (Может дублировать или удалять кадры)",
...
spanish = {StringsEnum.CONFIG_TAB_LABEL: "Configuración",
           ...
           StringsEnum.USE_OVERLAY_CHECKBOX_LABEL: "Usar superposición",
           ...
           StringsEnum.FPS_SELECTOR_TOOLTIP: "Elija fps para guardar en. (Puede duplicar o eliminar fotogramas)",
           ...
           StringsEnum.USE_OVERLAY_TOOLTIP: "Usar superposición en esta cámara.",
...
# TODO: Check chinese translations
...
chinese = {StringsEnum.CONFIG_TAB_LABEL: "组态",
           ...
           StringsEnum.FPS_SELECTOR_TOOLTIP: "选择fps保存。 （可能重复或丢帧）",
...
# TODO: Check japanese translations
# Japanese strings
japanese = {StringsEnum.CONFIG_TAB_LABEL: "構成",
            ...
            StringsEnum.FPS_SELECTOR_TOOLTIP: "保存先のfpsを選択します。 （フレームを複製またはドロップできます）",
