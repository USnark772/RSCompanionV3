...
from RSCompanionAsync.Model.app_defs import LangEnum, company_name, app_name
...
english = {StringsEnum.FILE: "File",
           ...
           StringsEnum.USE_CAMS: "Use video",
...
french = {StringsEnum.FILE: "Fichier",
          ...
          StringsEnum.CASCADE: "Cascade",
          StringsEnum.CUSTOM: "sur commande",
...
german = {StringsEnum.FILE: "Datei",
          ...
          StringsEnum.CUSTOM: "maßgeschneidert",
...
russian = {StringsEnum.FILE: "файл",
           ...
           StringsEnum.CUSTOM: "изготовленный на заказ",
...
spanish = {StringsEnum.FILE: "Expediente",
           ...
           StringsEnum.CUSTOM: "Personalizado",
