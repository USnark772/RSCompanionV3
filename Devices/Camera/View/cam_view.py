...
class CamView(AbstractView):
    ...
    def _set_texts(self) -> None:
        ...
        """
        self._logger.debug("running")
        self._initialization_bar_label.setText('Initialization progress')
        self._initialization_bar.setValue(0)
        self._image_display_label.setText("Preview")
        self._image_display.setText("Initializing")
        self._show_cam_checkbox_label.setText("Show feed")
        self._frame_size_selector_label.setText("Frame size")
        self._frame_rotation_setting_label.setText("Rotate image")
        self._fps_display_label.setText("FPS:")
        self._fps_display_value.setText("0")
        self._logger.debug("done")
    ...
    def _set_tooltips(self) -> None:
        ...
        self._show_cam_checkbox_frame.setToolTip(show_cam_tooltip)
        self._frame_size_selector_frame.setToolTip(frame_size_tooltip)
        self._frame_rotation_setting_frame.setToolTip(rotation_tooltip)
        self._image_display_frame.setToolTip(image_display_tooltip)
        self._fps_display_frame.setToolTip(fps_display_tooltip)
        self._logger.debug("done")
