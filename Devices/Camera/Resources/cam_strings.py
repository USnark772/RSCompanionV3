...
english = {StringsEnum.CONFIG_TAB_LABEL: "Configuration",
           ...
           StringsEnum.FPS_SELECTOR_TOOLTIP: "Limit camera FPS. (For if lag occurs)",
...
dutch = {StringsEnum.CONFIG_TAB_LABEL: "Configuratie",
         ...
         StringsEnum.FPS_SELECTOR_LABEL: "FPS Limiter",
         StringsEnum.FPS_DISPLAY_VALUE: "0",
         StringsEnum.FPS_SELECTOR_TOOLTIP: "Beperk camera FPS. (Voor als er vertraging optreedt)",
...
french = {StringsEnum.CONFIG_TAB_LABEL: "Configuration",
          ...
          StringsEnum.FPS_SELECTOR_LABEL: "FPS Limiter",
          StringsEnum.FPS_DISPLAY_VALUE: "0",
          StringsEnum.FPS_SELECTOR_TOOLTIP: "Limiter le FPS de la caméra. (Pour quand il y a un retard)",
...
german = {StringsEnum.CONFIG_TAB_LABEL: "Konfiguration",
          ...
          StringsEnum.FPS_DISPLAY_VALUE: "0",
          StringsEnum.FPS_SELECTOR_TOOLTIP: "Begrenzen Sie die Kamera-FPS. (Für wenn es eine Verzögerung gibt)",
...
russian = {StringsEnum.CONFIG_TAB_LABEL: "конфигурация",
           ...
           StringsEnum.FPS_SELECTOR_LABEL: "FPS Limiter",
           StringsEnum.FPS_DISPLAY_VALUE: "0",
           StringsEnum.FPS_SELECTOR_TOOLTIP: "Предельная камера FPS. (Когда есть задержка)",
...
spanish = {StringsEnum.CONFIG_TAB_LABEL: "Configuración",
           ...
           StringsEnum.FPS_DISPLAY_VALUE: "0",
           StringsEnum.FPS_SELECTOR_TOOLTIP: "Límite de cámara FPS. (Para cuando hay un retraso)",
