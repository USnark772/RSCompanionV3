...
french = {StringsEnum.CUSTOM_LABEL: "Douane",
          ...
          StringsEnum.TOGGLE_LABEL: "Basculer l'objectif",
          ...
          StringsEnum.DEBOUNCE_TOOLTIP: "Réglez le temps de rebond.",
          StringsEnum.BUTTON_MODE_TOOLTIP: "Définissez le mode du bouton sur Cliquer ou Tenir.",
          ...
          StringsEnum.TOGGLE_TOOLTIP: "Ouverture/fermeture manuelle de l'objectif.",
